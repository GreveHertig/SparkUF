...
// Skrevs när demot låg som en kopia bredvid det gamla demot (som hade
// "spark:demo-state"). Det gamla demot är borttaget, men nyckeln är kvar:
// besökare kan ha det gamla demots läge sparat, och det ska inte läsas in
// i det här demot.
//
...
// "spark:demo-state". Medan man är i /demo pekas lagrets
