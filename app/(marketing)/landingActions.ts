...
/**
 * Väntelistan på /. Ett tunt lager framför Oskars
...
export type LandingWaitlistErrorCode = "email_invalid" | "email_undeliverable" | "unexpected" | "rate_limited";

export type LandingWaitlistState =
  | { status: "joined" }
  | { status: "error"; code: LandingWaitlistErrorCode }
  | undefined;
...
export async function joinLandingWaitlist(
  _prevState: LandingWaitlistState,
  formData: FormData,
): Promise<LandingWaitlistState> {
