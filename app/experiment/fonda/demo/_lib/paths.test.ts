...
/** Sidfilen som en kopians rutt motsvarar, med hänsyn till route-grupperna. */
...
describe("kopians rutter", () => {
  it("varje rundturstopp pekar på en sida som finns i kopian", () => {
