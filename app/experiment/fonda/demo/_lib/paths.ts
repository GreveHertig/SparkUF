/** Kopians rutter. */
export const FONDA_DEMO_BASE = "/experiment/fonda/demo";
...
/**
 * Rundturens stopp pekar på det riktiga demots rutter (adapters/demo/
 * tourSteps.ts, orörd). Översätter dem till kopians motsvarigheter.
 */
