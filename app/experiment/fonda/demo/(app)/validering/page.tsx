...
/**
 * Validering i kopian: nyckeltalen, antagandena som prövades, svaren från
              ...
              <li key={response.companyName} className="fd-panel fdd-quote">
                <div className="fdd-quote__head">
                  <div>
                    ...
                    <p className="fdd-muted">
                      {response.county}, {response.employees} {t.experimentFonda.registry.employeesUnit},{" "}
            ...
            <tbody>
              {data.rows.map((row) => (
                <tr key={row.companyName}>
                  ...
                  <td className="fdd-num">{row.employees}</td>
