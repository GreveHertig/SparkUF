...
import { Figures, Locked, PageHead, SimulationBlock } from "../../_components/DemoBlocks";
...
/**
 * Marknad i kopian: registrets nyckeltal med urval och källa, storleks-
...
export default function FondaDemoMarketPage() {
  ...
  const distribution = SIZE_BUCKETS.map((bucket) => ({
