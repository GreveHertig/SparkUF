...
export const sv = {
  ...
  validationPage: {
    title: "Valideringen",
    subtitle: "Allt som prövats mot verkliga kunder — vem som svarat, vad det bekräftar och vad domen blir.",
    kpiTitle: "Utskicket",
    contactedLabel: "Kontaktade",
    respondedLabel: "Svar",
    responseRateLabel: "Svarsfrekvens",
    openRateLabel: "Öppningsfrekvens",
    confidencePrefix: "Baserat på",
    confidenceContactedUnit: "kontaktade",
    confidenceRateSuffix: "svarsfrekvens",
    tableTitle: "Alla kontaktade",
    ...
    assumptionsTitle: "Antagandena som prövades",
    assumptionVerdict: {
      confirmed: "Bekräftat",
      contradicted: "Motsagt",
    },
    responsesTitle: "Svaren",
  ...
  marketingPage: {
    ...
    subtitle: "Budskapet, kanalerna och en 30-dagarsplan, byggda på dina egna bevis. Spark skriver utkasten, du publicerar.",
    context: "Används i steg 11 · Första kunderna",
    messageTitle: "Budskapet",
    headlineLabel: "Huvudbudskap",
    supportingLabel: "Stödbudskap",
    channelsTitle: "Kanalerna",
    channelVerdict: {
      recommended: "Börja här",
      notNow: "Inte nu",
    },
    planTitle: "30-dagarsplanen",
    weekLabel: "Vecka {week}",
    draftTitle: "Utkastet",
    draftHint: "Välj en aktivitet i planen så skriver Spark ett utkast.",
    draftNote: "Utkast. Spark publicerar aldrig något åt dig.",
    copyLabel: "Kopiera",
    copiedLabel: "Kopierat",
    basedOnLabel: "Bygger på",
    outcomeTitle: "Uppföljningen",
    outcomeEmpty: "Här syns utfallet vecka för vecka när du har börjat köra planen.",
    outcomeLabels: {
      posts: "Inlägg",
      replies: "Svar",
      meetings: "Möten",
  ...
  site: {
    nav: {
      label: "Huvudmeny",
      home: "Spark, till början av sidan",
      journey: "Resan",
      registry: "Registret",
      score: "Poängen",
      price: "Pris",
    },
    demoLink: { label: "Se demot", note: "Exempel med påhittad data" },
    notifyLink: "Få besked",
    hero: {
      titleStart: "En AI-medgrundare, från idé",
      titleEm: "till första kunden.",
      lede: "Spark tar dig ett steg i taget, och varje svar vilar på riktig svensk företagsdata från Bolagsverket och SCB.",
    },
    proof: {
      regionLabel: "Exempel på poängen",
      idea: "Kvittojakten",
      ideaLine: "Påminnelser om underlag för redovisningsbyråer",
      fictional: "Exempel med påhittad data",
      scoreLabel: "Poäng",
      outOf: "av 100",
      toggle: "Tre kunder säger emot",
      toggleHint: "Slå på och se poängen räknas om, med samma beräkning som i demot.",
      sources: { profile: "Profilsamtalet", calls: "Kundsamtal" },
      deltaReason: "Tre av sex kunder säger emot problemet.",
      partsLabel: "Delarna som räknas i det här skedet",
      lockedCount: "{count} delar låses upp senare i resan",
      answersLabel: "Sex kundsvar om problemet",
      confirms: "Bekräftar",
      contradicts: "Säger emot",
    },
    journey: {
      titleStart: "Tolv steg.",
      titleEm: "Ett i taget.",
      lede: "Resan går genom fyra faser, från vem du är till de första betalande kunderna. Varje steg slutar med en konkret sak att göra.",
      phaseSteps: "Steg {from}-{to}",
      stepsListLabel: "Resans tolv steg",
    },
    registry: {
      titleStart: "Vi pekar på registret",
      titleEm: "i stället för att gissa.",
      body: "Varje siffra har en källa och ett datum. Saknas en källa säger Spark att den inte vet.",
      points: [
        "Marknadens storlek ur Bolagsverket och SCB, inte ur en uppskattning.",
        "Kundlistor med namngivna företag som finns i registret.",
        "Källa och datum på varje siffra, ett klick bort.",
      ],
      cardSni: "SNI {code}",
    ...
    score: {
      titleStart: "Poängen mäter bevis.",
      titleEm: "Den kan sjunka.",
      lede: "Poängen visar hur väl idén är belagd, inte hur lovande den låter. Den har åtta delar med fasta vikter, och ett nej från en kund räknas lika fullt som ett ja.",
      weightsLabel: "Så väger delarna, av 100",
      rules: [
        { title: "Ingen poäng utan källa", body: "Ett påstående utan underlag ger inga poäng, hur rimligt det än låter." },
        { title: "Motsägelser räknas", body: "Säger kunderna emot sjunker poängen, och du ser varför och var det kommer ifrån." },
        { title: "Simuleringar ger aldrig poäng", body: "Simulerade svar märks Simulering och hålls utanför poängen." },
      ],
    },
    cofounder: {
      titleStart: "En medgrundare som säger",
      titleEm: "vad du ska göra nu.",
      body: "Efter varje steg läser Medgrundaren underlaget och ger dig en sak att göra: vad, varför och hur mycket den kan flytta poängen.",
      cardLabel: "Nästa steg i demot",
      doneLabel: "Redan klart",
      pointsTemplate: "Kan ge upp till {points} poäng",
      fictionalNote: "Ur demots fiktiva scenario.",
    },
    price: {
      titleStart: "Ett pris,",
      titleEm: "hela resan.",
      ...
      amount: "199 kr",
      unit: "/mån",
      description: "Från första samtalet till kapitalet.",
      features: [
        "Resans steg 01-09 och 11-12",
        "Pulsen: signaler om din marknad, med källa",
        "Juridisk koll för enskild firma och aktiebolag",
      ],
      excluded: "Steg 10, bygget, ingår inte.",
      note: "Priset är ett förslag och inte fastställt.",
    },
    close: {
    ...
    footer: { note: "Demot visar påhittade företag och personer." },
    demo: {
      ...
      unlocksAfter: "Låses upp efter steg {step}",
      pointsGain: "+{points}",
      bar: {
        label: "Demoraden",
        back: "Bakåt",
        next: "Nästa",
        position: "Moment {current} av {total}",
        reset: "Börja om",
        resetConfirm: "Börja om demot från första steget?",
      },
    },
  },
