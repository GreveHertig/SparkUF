...
export const en = {
  ...
  validationPage: {
    ...
    subtitle: "Everything tested against real customers — who responded, what it confirms and what the verdict is.",
    kpiTitle: "The outreach",
    contactedLabel: "Contacted",
    respondedLabel: "Responses",
    responseRateLabel: "Response rate",
    openRateLabel: "Open rate",
    confidencePrefix: "Based on",
    confidenceContactedUnit: "contacted",
    confidenceRateSuffix: "response rate",
    tableTitle: "All contacted",
    ...
    assumptionsTitle: "The assumptions that were tested",
    assumptionVerdict: {
      confirmed: "Confirmed",
      contradicted: "Contradicted",
    },
    responsesTitle: "The responses",
  ...
  marketingPage: {
    title: "Marketing",
    subtitle: "The message, the channels and a 30-day plan, built on your own evidence. Spark writes the drafts, you publish.",
    context: "Used in step 11 · The first customers",
    messageTitle: "The message",
    headlineLabel: "Headline",
    supportingLabel: "Supporting messages",
    channelsTitle: "The channels",
    channelVerdict: {
    ...
    weekLabel: "Week {week}",
    draftTitle: "The draft",
    draftHint: "Pick an activity in the plan and Spark writes a draft.",
    draftNote: "Draft. Spark never publishes anything for you.",
    copyLabel: "Copy",
    copiedLabel: "Copied",
    basedOnLabel: "Based on",
    outcomeTitle: "The follow-up",
    outcomeEmpty: "The results show up here week by week once you start running the plan.",
    outcomeLabels: {
      posts: "Posts",
      replies: "Replies",
      meetings: "Meetings",
  ...
  site: {
    nav: {
      label: "Main menu",
      home: "Spark, back to the top",
      journey: "The journey",
      registry: "The register",
      score: "The score",
      price: "Pricing",
    },
    demoLink: { label: "See the demo", note: "Example with made-up data" },
    notifyLink: "Get notified",
    hero: {
      titleStart: "An AI co-founder, from idea",
      titleEm: "to first customer.",
      lede: "Spark takes you one step at a time, and every answer rests on real Swedish company data from Bolagsverket and SCB.",
    },
    proof: {
      regionLabel: "Score example",
      idea: "Kvittojakten",
      ideaLine: "Paperwork reminders for accounting firms",
      fictional: "Example with made-up data",
      scoreLabel: "Score",
      outOf: "of 100",
      toggle: "Three customers disagree",
      toggleHint: "Turn it on and watch the score recalculate, using the same calculation as the demo.",
      sources: { profile: "Profile chat", calls: "Customer calls" },
      deltaReason: "Three of six customers contradict the problem.",
      partsLabel: "The parts that count at this stage",
      lockedCount: "{count} parts unlock later in the journey",
      answersLabel: "Six customer answers about the problem",
      confirms: "Confirms",
      contradicts: "Disagrees",
    },
    journey: {
      titleStart: "Twelve steps.",
      titleEm: "One at a time.",
      lede: "The journey runs through four phases, from who you are to your first paying customers. Every step ends with one concrete thing to do.",
      phaseSteps: "Steps {from}-{to}",
      stepsListLabel: "The twelve steps of the journey",
    },
    registry: {
      titleStart: "We point to the register",
      titleEm: "instead of guessing.",
      body: "Every number has a source and a date. When there is no source, Spark says it does not know.",
      points: [
        "Market size from Bolagsverket and SCB, not from an estimate.",
        "Customer lists with named companies that exist in the register.",
        "Source and date on every number, one click away.",
      ],
      cardSni: "SNI {code}",
    ...
    score: {
      titleStart: "The score measures evidence.",
      titleEm: "It can go down.",
      lede: "The score shows how well the idea is backed up, not how promising it sounds. It has eight parts with fixed weights, and a no from a customer counts as fully as a yes.",
      weightsLabel: "How the parts weigh, out of 100",
      rules: [
        { title: "No points without a source", body: "A claim without evidence earns nothing, however reasonable it sounds." },
        { title: "Contradictions count", body: "When customers disagree the score drops, and you see why and where it came from." },
        { title: "Simulations never score", body: "Simulated answers are labelled Simulation and kept out of the score." },
      ],
    },
    cofounder: {
      titleStart: "A co-founder that tells you",
      titleEm: "what to do now.",
      body: "After every step the Co-founder reads the evidence and gives you one thing to do: what, why and how much it can move the score.",
      cardLabel: "Next step in the demo",
      doneLabel: "Already done",
      pointsTemplate: "Worth up to {points} points",
      fictionalNote: "From the demo's fictional scenario.",
    },
    price: {
      titleStart: "One price,",
      titleEm: "the whole journey.",
      name: "Founder",
      amount: "SEK 199",
      unit: "/month",
      description: "From the first call to raising capital.",
      features: [
        "Journey steps 01-09 and 11-12",
        "The Pulse: signals about your market, with sources",
        "Legal check for sole traders and limited companies",
      ],
      excluded: "Step 10, the build, is not included.",
      note: "The price is a proposal and not final.",
    },
    close: {
    ...
    footer: { note: "The demo shows made-up companies and people." },
    demo: {
      ...
      unlocksAfter: "Unlocks after step {step}",
      pointsGain: "+{points}",
      bar: {
        label: "Demo bar",
        back: "Back",
        next: "Next",
        position: "Moment {current} of {total}",
        reset: "Start over",
        resetConfirm: "Start the demo over from the first step?",
      },
    },
  },
